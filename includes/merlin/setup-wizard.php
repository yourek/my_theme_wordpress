...
*************************************************************/
function clotya_local_import_files() {
	return array(
		array(
...
add_filter( 'merlin_import_files', 'clotya_local_import_files' );

/************************************************************
## Setup Wizard After Import
*************************************************************/
function clotya_merlin_after_import_setup() {
...
add_action( 'merlin_after_all_import', 'clotya_merlin_after_import_setup' );
